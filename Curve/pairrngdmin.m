...
% and the polynomial degree (shapeFuncDg) as inputs, and returns four outputs, among
% which two are 2d matrices of the shape function values and their corresponding knot
